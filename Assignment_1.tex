...
\begin{figure}[ht]
    \centering
    \includesvg[inkscapelatex=false, width=\textwidth]{Assignment_1/output_plots/matrix_all_bilinear_factor=40.svg}
    \includesvg[inkscapelatex=false, width=\textwidth]{Assignment_1/output_plots/matrix_all_nearest_factor=40.svg}
