...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth]{Assignment_4/output_plots/wirebondmask_Bbigsquare_eroded_all.svg}
    \caption{Overview of the two dilation operations of assignment (c), using the SE's $B^1$ (Figure~\ref{fig:SE_B1}) and $B^3$ (Figure~\ref{fig:SE_B3}).}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth]{Assignment_4/output_plots/wirebondmask_variousse_eroded_all.svg}
    \caption{Overview of the two dilation operations of assignment (c), using the SE's $B^1$ (Figure~\ref{fig:SE_B1}) and $B^3$ (Figure~\ref{fig:SE_B3}).}
